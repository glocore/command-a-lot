// https://github.com/electron/fiddle/blob/fbb7e3389bef926ce9e0063451943b6bb596cdaf/tests/mocks/electron.ts

import { EventEmitter } from "events";

import { BrowserWindowMock } from "./BrowserWindow";
import { WebContentsMock } from "./WebContents";
import { vi } from "vitest";

const createdNotifications: Array<NotificationMock> = [];

class UtilityProcessMock extends EventEmitter {
  public static fork = vi.fn().mockReturnValue(new UtilityProcessMock());
  public pid = 1;
  public kill = vi.fn();
  public on = vi.fn();
  public off = vi.fn();
...
export const app = {
  ...
  getName: vi.fn().mockReturnValue("Command-a-lot"),
  exit: vi.fn(),
  hide: vi.fn(),
  show: vi.fn(),
...
const electronMock = {
  ...
  shell,
  systemPreferences,
  utilityProcess: UtilityProcessMock,
...
console.log("INSIDE ELECTRON MOCK");
